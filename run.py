...
# 定义多个数据目录
base_dir = r"D:\yzx_code\test_data\dianxingshuzishenghuoBackend"
...
for id in name_id:
    ...
    model_path = os.path.join(dataws_dir,"output_models-p300w-warmup-length5k-refine_every_200")
    # 构造命令
    cmd_run_nerfstudio = [
        "python", "run_nerfstudio.py",
        "-s", base_dir,
        "--model_id",id,
